      ...
      <div className="flex flex-col items-center justify-center md:flex-row md:justify-between">
        <span className="text-sm text-gray-500 text-center dark:text-gray-400">
          © {" "}
           ...
           {" "}PyEcZenith™. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0 md:text-xl">
          ...
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://linkedin.com/in/PyEcZenith"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsLinkedin />
          </motion.a>
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://twitter.com/PyEcZenith"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsTwitter />
          </motion.a>
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://instagram.com/PyEcZenith"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsInstagram />
          </motion.a>
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://facebook.com/PyEcZenith"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsFacebook />
          </motion.a>
